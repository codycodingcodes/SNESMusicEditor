        ...
        public static void playMusic(int totalChannel, Pattern[] pattern, ArrayList<ChannelValues> channelValues,
                ...
                for (int i = 0; i < totalChannel; i++) {
                        ...
                        pattern[i] = new Pattern(
                                        "V" + channelValues.get(i).getChannel() + " I[" + meU.getInstrument().get(i)
                        ...
                        public void run() {
                                ...
                                if (totalChannel == 1) {
                                        player.play(pattern[0]
                                                        .repeat(Integer.parseInt(channelValues.get(0).getRepeatValue()))
                                        ...
                                        player.play(
                                                        pattern[0].repeat(Integer.parseInt(
                                                                        channelValues.get(0).getRepeatValue()))
                                                                        .setTempo(Integer.parseInt(channelValues.get(0)
                                                                                        .getTempo())),

                                                        pattern[1].repeat(Integer.parseInt(
                                                                        channelValues.get(1).getRepeatValue()))
                                                                        .setTempo(Integer.parseInt(channelValues.get(1)
                                                                                        .getTempo())));
                                }
                                        ...
                                        player.play(
                                                        ...
                                                        pattern[2].repeat(Integer.parseInt(
                                                                        channelValues.get(2).getRepeatValue()))
                                                                        .setTempo(Integer.parseInt(channelValues.get(2)
                                                                                        .getTempo())));
                                        ...
                                        player.play(
                                                        ...
                                                        pattern[3].repeat(Integer.parseInt(
                                                                        channelValues.get(3).getRepeatValue()))
                                                                        .setTempo(Integer.parseInt(channelValues.get(3)
                                                                                        .getTempo())));
                                }
                                        ...
                                        player.play(
                                                        ...
                                                        pattern[4].repeat(Integer.parseInt(
                                                                        channelValues.get(4).getRepeatValue()))
                                                                        .setTempo(Integer.parseInt(channelValues.get(4)
                                                                                        .getTempo())));
                                }
                                        ...
                                        player.play(
                                                        ...
                                                        pattern[5].repeat(Integer.parseInt(
                                                                        channelValues.get(5).getRepeatValue()))
                                                                        .setTempo(Integer.parseInt(channelValues.get(5)
                                                                                        .getTempo())));
                                }
                                        ...
                                        player.play(
                                                        ...
                                                        pattern[6].repeat(Integer.parseInt(
                                                                        channelValues.get(6).getRepeatValue()))
                                                                        .setTempo(Integer.parseInt(channelValues.get(6)
                                                                                        .getTempo())));
                                }
